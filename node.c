...
struct node* node_pop() {
    ...
    struct node* last_node_root = NULL;

    if (!vector_empty(node_vector_root)) { // Correção temporária para o root_vector vazio
        last_node_root = vector_back_ptr(node_vector_root);
    }
